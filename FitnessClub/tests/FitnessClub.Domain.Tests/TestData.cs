...
public static class TestData
{
    public static List<Specialization> Specializations { get; } = new()
    {
        ...
        new Specialization { ID = "8",  Name = "Дегустация майонеза" },
        new Specialization { ID = "9",  Name = "Боевые искусства войны" },
    ...
    public static List<Trainer> Trainers { get; } = new()
    {
        ...
        new Trainer { PassportNumber = "8901 234567", FullName = "Ярослав Юрьевич Дронов",
            ...
            Experience = 1,
            Gender = Gender.Female, BirthDate = new DateOnly(1991, 11, 22) },
    ...
    public static List<Booking> Bookings { get; } = new()
    {
        ...
        new Booking { Client = Clients[4], Trainer = Trainers[4], Hall = Halls[4],
            DateTime = new DateTime(2025, 1, 1, 16, 0, 0), IsTrial = true },
        ...
        new Booking { Client = Clients[6], Trainer = Trainers[6], Hall = Halls[0],
            DateTime = new DateTime(2026, 5, 29, 13, 15, 0), IsTrial = false },
